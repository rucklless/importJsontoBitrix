...
class OffersTable extends Main\Entity\DataManager
{
	...
	public static function deleteBundle($id)
	{
		...
		$itemsFromDbList = OffersTable::getList(
			array(
				"filter" => array(
					'SET_PARENT_ID' => $id,
				),
		...
		while ($itemsFromDbItem = $itemsFromDbList->fetch())
			OffersTable::deleteWithItems($itemsFromDbItem['ID']);

		return OffersTable::deleteWithItems($id);
	}
