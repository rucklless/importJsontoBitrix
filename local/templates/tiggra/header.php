...
<!DOCTYPE html>
										...
										<div class="row">
											<div class="input-block col-12">
												...
												<div class="button-wrap">
													<button class=""><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<!-- Slide Left Menu -->
			...
			<?$APPLICATION->IncludeComponent("bitrix:menu", "slide-menu", Array(
