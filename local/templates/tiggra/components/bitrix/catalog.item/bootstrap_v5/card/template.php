...
<div class="item-goods">
	...
	<div class="img">
		<div class="slider-control-wrap">
			<div class="slider-control-inner-wrap">
			<span class="product-item-image-slider-control-container-b5" id="<?=$itemIds['PICT_SLIDER']?>_indicator"
			...
			if ($showSlider)
			{
				...
				{
					?>
					<span class="product-item-image-slider-control-b5<?=($key == 0 ? ' active' : '')?>" data-go-to="<?=$key?>"></span>
					<?
				}
			}
			?>
							...
							if ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y')
							{
								...
								<div class="product-item-button-container">
									...
									<div id="<?=$itemIds['BASKET_ACTIONS']?>" <?=($actualItem['CAN_BUY'] ? '' : 'style="display: none;"')?>>
										<button class="btn temp-color-btn" id="<?=$itemIds['BUY_LINK']?>"
												href="javascript:void(0)" rel="nofollow">
											<?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?>
										</button>
									</div>
