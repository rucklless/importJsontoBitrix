...
<footer class="footer">
	<div class="footer-top">
		<div class="container">
			<div class="row">
				<div class="col-12 col-lg item">
					<div class="top">
						<p class="title">Доставка</p>
						<p class="subtitle">от 48 часов</p>
					</div>
					<div class="description">Срок зависит от месторасположения товара: склад Москва/Европа/производство Китай</div>
				</div>
				<div class="col-12 col-lg item">
					<div class="top">
						<p class="title">Оплата</p>
						<p class="subtitle">Все виды оплаты</p>
					</div>
					<div class="description">Наличный и безналичный расчет. Подробности уточняйте у менеджеров по продажам</div>
				</div>
				<div class="col-12 col-lg item">
					<div class="top">
						<p class="title">Шоурум</p>
						<p class="subtitle">19.000+ живых образцов</p>
					</div>
					<div class="description">Шоурум всегда ждет своих гостей. Каждому посетителю -ПОДАРОК</div>
				</div>
				<div class="col-12 col-lg item">
					<div class="top">
						<p class="title">Эксклюзивные подарки</p>
						<p class="subtitle">Тренды появляются у нас</p>
					</div>
					<div class="description">Мы регулярно  посещаем все известные мировые выставки. Узнавайте первыми!</div>
				</div>
			</div>
		</div>
	</div>
	<div class="footer-bottom">
		<div class="container wrapper">
			<div class="left">
				<div class="logo">
					<picture><source srcset="/local/templates/tiggra/img/logo.webp" type="image/webp"><img src="/local/templates/tiggra/img/logo.jpeg" alt=""></picture>
				</div>
				<div class="copyright">
					© 2020-2021 ООО «Тигрра»<br>
					<a href="/consent.html">О персональных данных</a> / <a href="/agreement.html">Условие использования</a><br>
					<a href="https://plarson.ru/" target="_blank">Создание сайта - test</a>
				</div>
			</div>
			<div class="center">
				<div class="bottom-menu">
					<a href="/files/ADMOS_Company_Profile_2019.pdf" target="_blank">About company</a>
					<a href="/about.html">О компании</a>
					<a href="/contacts.html">Контакты</a>
					<a href="/portfolio/">Портфолио</a>
					<a href="/providers.html">Поставщики</a>
					<a href="/vacancies.html">Вакансии</a>
					<a href="/gifting_day.html">День подарка</a>
					...
					<a href="/charity.html">Социальная политика</a>
					<a href="/terms.html">Условия сотрудничества</a>
					<a href="/brief_souvenir.html">Заполнить бриф</a>
					<a href="/faq.html">FAQ</a>
				</div>
			</div>
			<div class="right">
				<div class="phone"><a href="tel:+79876543210">+7(987)654-32-10</a></div>
				<div class="mail"><a href="mailto:test@test.ru">test@test.ru</a></div>
				<div class="address">
					Самара
				</div>
				<div class="social">
...
<script src="/local/templates/tiggra/assets/owl/owl.carousel.min.js"></script>
<script src="/local/templates/tiggra/js/script.js"></script>
</div>
	<div class="basket-fly">
		...
		<a class="favorite fly-item" title="Избранное">
			<div class="icon">
		...
		<a class="callback fly-item" title="Заказать звонок">
			<div class="icon">
			<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		<a class="sendquestions fly-item" title="Задать вопрос">
			<div class="icon">
			<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
{	global $APPLICATION;
	if($APPLICATION->GetPageProperty('hide_h1') != 'y'){
