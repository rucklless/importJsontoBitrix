...
?>
<?$APPLICATION->IncludeComponent("crtech:offers", "bootstrap_v4", Array(
	"ACTION_VARIABLE" => "basketAction",	// Название переменной действия
		...
		"COLUMNS_LIST_MOBILE" => "",	// Колонки, отображаемые на мобильных устройствах
		...
		"GIFTS_PLACE" => "TOP",	// Вывод блока "Подарки"
